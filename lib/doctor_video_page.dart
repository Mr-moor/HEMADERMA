...
class DoctorVideoPage extends StatefulWidget {
  @override
  _DoctorVideoPageState createState() => _DoctorVideoPageState();
}

class _DoctorVideoPageState extends State<DoctorVideoPage> {
