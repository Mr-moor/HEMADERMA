...
class _LabTechnicianRegistrationPageState
  ...
  String _role = 'lab_technician'; // Default role for doctor registration
  String _username = '';
  String _password = '';
  ...
  Future<void> _registerLabTechnician() async {
    if (_formKey.currentState!.validate()) {
      _formKey.currentState!.save();

      String hashedPassword = _dbHelper.hashPassword(_password);

      Map<String, dynamic> labtechnicianData = {
...
DatabaseHelper.columnRole: _role,
      ...
      await _dbHelper.insertLabtechnician(labtechnicianData);
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('lab technician registered successfully!')),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('lab technician Registration')),
      body: Padding(
