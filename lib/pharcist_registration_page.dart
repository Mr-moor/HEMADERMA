...
class PharmacistRegistrationPage extends StatefulWidget {
  @override
  _PharmacistRegistrationPageState createState() =>
...
class _PharmacistRegistrationPageState
  ...
  String _role = 'pharmacist'; // Default role for doctor registration
  String _username = '';
  String _password = '';
  ...
  Future<void> _registerPharmacist() async {
    if (_formKey.currentState!.validate()) {
      ...
      Map<String, dynamic> pharmacistsData = {
...
DatabaseHelper.columnRole: _role,
      ...
      await _dbHelper.insertpharmacist(pharmacistsData);
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('pharmacist registered successfully!')),
      );
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('pharmacist Registration')),
      body: Padding(
